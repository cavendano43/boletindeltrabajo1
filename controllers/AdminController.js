...
class AdminController{
    static getNewsletter = async(req,res)=>{
        try{
            ...
            return res.status(404).send({code:404,status:false,message:"error del servidor"});
        }
    }
    ...
    static preguntasfrecuentesPost = async (req,res)=>{
        try {
            ...
            preguntasModel.save();
            return res.json.status(200).json({code:200,status:true,message:"Registro exítoso"});
        } catch(e) {
            return res.status(404).send({code:404,status:false,message:"error del servidor"});
        }
    }
    ...
    static indicadoresPut = async(req,res)=>{
        try{
            ...
            return res.json.status(200).json({code:200,status:true,payload:updatedIndicador});
        } catch(e) {
            return res.status(404).send({code:404,status:false,message:"error del servidor"});
        }
    }
